...
<main id="projects" class="flex justify-center items-center mt-20">
    <div class="flex justify-center items-center">
        <div class="flex flex-col sm:flex-row items-center text-center sm:text-left">
            ...
            <div class="px-5">
                <h1 class="text-blue-600 text-3xl font-bold">About Me</h1>
                <p class="font-bold text-3xl">Front-End Developer Based in The Netherlands 📍</p>
                <p class="text-slate-700 text-lg mt-2">Hey, my name is Nathan, and I'm a Frontend Developer. <br> My passion is to create and develop a clean UI/UX for my users.</p>
            </div>
        </div>
    </div>
</main>